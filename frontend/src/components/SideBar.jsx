const SideBar = ({
    ...
    return (
            <div className={`${isSideBar ? "left-0" : "-left-32"} bg-teal-400 h-full pt-16 w-32 absolute min-h-full transition-all shadow-md flex flex-col items-center text-white sm:left-0`}>
